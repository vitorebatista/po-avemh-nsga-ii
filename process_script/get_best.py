...
def get_best(market, alg):
    f = open("../tmp/{}/{}/igd.txt".format(market, alg), "r")
    last = ""
    igd_lst = []
    for line in f:
...
for i, market in enumerate(markets):
    ...
    # create folders
    cmd1 = "mkdir ./{}/final_pop ./{}/igd".format(
        market, market)
    os.system(cmd0)
    os.system(cmd1)
    for alg in algs:
        ...
        cmd2 = "cp ../tmp/{}/{}/{}.csv ./{}/final_pop/{}.csv".format(
            market, alg, best, market, alg)
        os.system(cmd2)
    ...
    # cmd3 = "cp ./{}/final_pop/lvx.csv ./{}/final_pop/levy.csv".format(
    #     market, market)
    # cmd4 = "cp ./{}/final_pop/de.csv ./{}/final_pop/const.csv".format(
    #     market, market)
    # os.system(cmd3)
    # os.system(cmd4)
