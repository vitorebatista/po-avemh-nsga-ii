...
def load_sol(market, alg):
    print("./{}/final_pop/{}.csv".format(market, alg))
    dat = pd.read_csv(
        "./{}/final_pop/{}.csv".format(market, alg), delimiter=",")
...
xlims = [(0.001, 0.0015), (0.0005, 0.0008), (0.0003, 0.0004),
         (0.0005, 0.001), (0.0004, 0.0008)]
ylims = [(0.006, 0.008), (0.008, 0.009), (0.004, 0.006),
         (0.006, 0.008), (0.0015, 0.0035)]
...
for style in styles:
    ...
    for i, market in enumerate(markets):
        ...
        pf = pd.DataFrame(np.genfromtxt(
            "./{}/portef.txt".format(market)), columns=["return", "risk"])
